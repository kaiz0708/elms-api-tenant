...
@EnableJpaRepositories(basePackages = {"com.elms.api.storage.tenant.model", "com.elms.api.storage.tenant.repository"},
...
public class TenantDatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(
        ...
        emfBean.setPackagesToScan(new String[]{"com.elms.api.storage.tenant.model", "com.elms.api.storage.tenant.repository" });
